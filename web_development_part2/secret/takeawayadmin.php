...
<head>
    ...
    <title>Admin - Takeaway orders</title>
...
<h2 style="margin-top: 1em;">Take away orders</h2>
            <br>
<!--admin voi hakea haluamansa tilausmäärän-->
<form  method='POST'>
  <label for="maara">Select the number of orders: </label><br>
  <input type="number" id="maara" name="maara"> <input type="submit" value="Search">
  <br>
</form>
<?php

#adminin antama tilausmäärän muuttuja, jolla haetaan (alempana) tietokannasta haluttu määrä tilauksia

$maara=$_POST['maara'];

#Haetaan tietokannasta 10 viimeisintä tilausta
...
ORDER BY tilausnro DESC LIMIT $maara");

print "<br><h3>Orders by customers</h3>";
...
<button type="button" style = "background-color: rgba(59, 59, 59, 0.897); border-color: rgb(59, 59, 59);"><a href="feedbackadmin.php">Feedbacks</a></button> <br><br> 
